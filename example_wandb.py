...
if __name__ == '__main__':
    ...
    wandb.init(project='taiyi', name='test_quantity_remove_hooksmodule3', config=config)
    ...
    vis = Visualization(monitor,visualize=wandb,project=config_taiyi.keys(),name=config_taiyi.values())
    #######################################
